...
The data you are rescuing will usually be composed of one or more plain-text files, most commonly as a **tab-separated values (.tsv)** file or a **comma-separated values (.csv)** file. These open file formats are widely supported, easy for software to read, and suitable for long-term preservation and sharing.
